...
if (!window.__speechTranslatorInitialized) {
  ...
  function initOverlayUI() {
    ...
    overlayContainer.innerHTML = `
      <div class="st-header">
        ...
        <div class="st-controls">
          ...
          <button id="st-btn-clear"  class="st-icon-btn" title="Hapus Riwayat">&#128465;</button>
      ...
      <div class="st-body-content" id="st-body-content">
        <div class="st-transcript-list" id="st-transcript-list">
          <div class="st-placeholder" id="st-placeholder">
            <p>&#127908; Bicara di mikrofon Anda atau dengarkan pembicara rapat...</p>
    ...
    document.getElementById('st-btn-clear').addEventListener('click', () => {
      ...
      transcriptList.innerHTML = `
        <div class="st-placeholder" id="st-placeholder">
          <p>&#127908; Riwayat dibersihkan. Menunggu suara baru...</p>
        </div>`;
      transcriptCount = 0;
      updateCountBadge();
    });
  ...
  function displaySubtitle(data) {
    ...
    const speakerLabel = isPeer ? '&#128266; Lawan Bicara (Media)' : '&#127908; Suara Anda (Mic)';
    ...
    card.innerHTML = `
      <div class="st-card-header">
        ...
        <span class="st-card-meta">${(data.lang || '').toUpperCase()} &middot; ${timeStr} &middot; ${data.latency || 0}ms</span>
      </div>
